        ...
        return `
            ...
            <div class="card mb-6">
                <div class="card-header">
                    <h3 class="card-title">${this.__('profile.personalInfo')}</h3>
                </div>
                <div class="card-body">
            ...
            <div class="card mb-6">
                <div class="card-header">
                    <h3 class="card-title">${this.__('profile.changePassword')}</h3>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">${this.__('profile.accountInfo')}</h3>
                </div>
                <div class="card-body">
                    <div class="space-y-3 text-sm">
                        <div class="flex justify-between py-2 border-b">
                            <span class="text-gray-500">${this.__('profile.company')}</span>
                            <span class="font-medium">${this.user.company_name || '-'}</span>
                        </div>
                        <div class="flex justify-between py-2 border-b">
                            <span class="text-gray-500">${this.__('profile.role')}</span>
                            <span class="font-medium">${this.getRoleLabel(this.user.role)}</span>
                        </div>
                        <div class="flex justify-between py-2 border-b">
                            <span class="text-gray-500">${this.__('profile.createdAt')}</span>
                            <span class="font-medium">${this.formatDate(this.user.created_at)}</span>
                        </div>
                        <div class="flex justify-between py-2">
                            <span class="text-gray-500">${this.__('profile.lastLogin')}</span>
                            <span class="font-medium">${this.formatDateTime(this.user.last_login_at)}</span>
                        </div>
                    </div>
                </div>
            </div>
